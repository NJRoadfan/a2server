...
wget -O files/external/source/cicpoffs.zip https://github.com/NJRoadfan/cicpoffs/archive/refs/heads/various-fixes.zip
wget -O files/external/source/netatalk-4.5.0.tar.xz https://github.com/Netatalk/netatalk/releases/download/netatalk-4-5-0/netatalk-4.5.0.tar.xz
